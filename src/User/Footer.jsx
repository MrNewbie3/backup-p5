        ...
        <div className="flex-col justify-center items-center gap-6 flex">
          <div className="w-[190px] py-2.5 justify-center items-center gap-2 inline-flex">
            <svg width="31" height="24" viewBox="0 0 31 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path id="Vector" fill-rule="evenodd" clip-rule="evenodd" d="M7.98368 0.806641L0.480469 8.30985L8.00975 15.8391L15.5129 23.3424L30.5192 8.33598L23.0161 0.832792L15.513 8.33592L7.98368 0.806641Z" fill="#101010" />
            </svg>

            <div className="text-center text-stone-950 text-[32px] font-semibold font-['Manrope'] leading-[38.40px]">Cantogo</div>
          </div>
